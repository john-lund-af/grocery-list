...
const Header = () => {
  ...
  return (
    <header className="opacity-90 fixed flex flex-row justify-between items-center w-full px-4 py-6 bg-skin-fill z-50 dark:bg-skin-dark-fill text-skin-inverted dark:text-skin-dark-base">
